...
export declare const NODE_PACKAGE_CONTRACT: {
    readonly extension: ".node";
    readonly mimeType: "application/x-connectingmatrix-node";
    readonly importer: "@connectingmatrix/workflows -> @connectingmatrix/nodes -> @connectingmatrix/file";
    readonly executor: "@connectingmatrix/nodes.execute";
    readonly validator: "@connectingmatrix/nodes.validate";
};
export declare const NODE_SANCTIONED_MODULES: string[];
...
export declare const Nodes: {
    ...
    createWithAI(input: {
        ...
        nodePackage: NodePackageFile | undefined;
    ...
    launcher: typeof import("./launcher.js").createConnectingmatrixNodesStubLauncher;
...
export declare const graphql: {
    ...
    resolvers: {
        Query: {
            ...
            nodesExportPackage: (_: unknown, args: {
                id: string;
