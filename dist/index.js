...
export const NODE_PACKAGE_CONTRACT = { extension: '.node', mimeType: 'application/x-connectingmatrix-node', importer: '@connectingmatrix/workflows -> @connectingmatrix/nodes -> @connectingmatrix/file', executor: '@connectingmatrix/nodes.execute', validator: '@connectingmatrix/nodes.validate' };
export const NODE_SANCTIONED_MODULES = ['lodash', 'zod', 'd3', 'arquero'];
