...
- Path: `packages/apps/workflow-nodes/src/services/mcp/tools`
...
- Logic gates summary:
  ...
  - This file is a compatibility re-export bridge to `@giga/mcp` node MCP tools.
- Functions (all):
  - None.
- Exports:
  - `nodeMcpTools`
- Key snippets and use-case mapping:
  - `L1-L1`: Re-export compatibility surface for workflow-nodes imports.
