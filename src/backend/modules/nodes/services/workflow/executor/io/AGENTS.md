...
- Path: `packages/apps/workflow-nodes/src/services/workflow/executor/io`
...
- Functions (all):
  - `workflowNodesRoots` (L11-L11, arrow)
  - `readManifestSha` (L18-L18, arrow)
  - `readNodeSourceFiles` (L34-L34, arrow)
  - `visit` (L38-L38, arrow)
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L11-L11`: Implements `workflowNodesRoots` for this module use case.
  - `L18-L18`: Implements `readManifestSha` for this module use case.
  - `L34-L34`: Implements `readNodeSourceFiles` for this module use case.
  - `L38-L38`: Implements `visit` for this module use case.
