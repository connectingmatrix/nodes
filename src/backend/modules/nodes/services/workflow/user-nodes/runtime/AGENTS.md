...
- Path: `packages/apps/workflow-nodes/src/services/workflow/user-nodes/runtime`
...
- Functions (all):
  - `packageInput` (L9-L9, arrow)
  - `uniqueCopySlug` (L41-L41, arrow)
  - `validateWorkflowNodePackage` (L60-L60, arrow)
- Exports:
  - `validateWorkflowNodePackage` (L60)
- Key snippets and use-case mapping:
  - `L9-L9`: Implements `packageInput` for this module use case.
  - `L41-L41`: Implements `uniqueCopySlug` for this module use case.
  - `L60-L60`: Implements `validateWorkflowNodePackage` for this module use case.
### `queries.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L112`: File-level constants/types behavior.
### `rules.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `importPattern` (L86-L86, arrow)
  - `assertWorkflowNodeSourceRules` (L156-L156, arrow)
  - `assertWorkflowNodePackageRules` (L162-L162, arrow)
- Exports:
  - `assertWorkflowNodeSourceRules` (L156)
  - `assertWorkflowNodePackageRules` (L162)
- Key snippets and use-case mapping:
  - `L86-L86`: Implements `importPattern` for this module use case.
  - `L156-L156`: Implements `assertWorkflowNodeSourceRules` for this module use case.
  - `L162-L162`: Implements `assertWorkflowNodePackageRules` for this module use case.
