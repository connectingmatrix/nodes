...
- Path: `packages/apps/workflow-nodes/src/services/workflow/nodes/auth`
...
- Functions (all):
  - `inputFor` (L10-L10, arrow)
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L10-L10`: Implements `inputFor` for this module use case.
