...
- Path: `packages/apps/workflow-nodes/src/services/workflow/nodes/io`
...
- Functions (all):
  - `fileChecksum` (L15-L15, arrow)
  - `scopedRoot` (L24-L24, arrow)
  - `scopedPath` (L32-L32, arrow)
  - `props` (L38-L38, arrow)
  - `driveInfo` (L46-L46, arrow)
  - `driveWriteAction` (L52-L52, arrow)
  - `assertDriveWritable` (L57-L57, arrow)
  - `graphContext` (L63-L63, arrow)
  - `workflowOrganizationId` (L71-L71, arrow)
  - `sharedSpace` (L74-L74, arrow)
  - `copySource` (L76-L76, arrow)
  - `fileRef` (L188-L188, arrow)
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L15-L15`: Implements `fileChecksum` for this module use case.
  - `L24-L24`: Implements `scopedRoot` for this module use case.
  - `L32-L32`: Implements `scopedPath` for this module use case.
  - `L38-L38`: Implements `props` for this module use case.
  - `L46-L46`: Implements `driveInfo` for this module use case.
  - `L52-L52`: Implements `driveWriteAction` for this module use case.
  - `L57-L57`: Implements `assertDriveWritable` for this module use case.
  - `L63-L63`: Implements `graphContext` for this module use case.
  - `L71-L71`: Implements `workflowOrganizationId` for this module use case.
  - `L74-L74`: Implements `sharedSpace` for this module use case.
  - `L76-L76`: Implements `copySource` for this module use case.
  - `L188-L188`: Implements `fileRef` for this module use case.
