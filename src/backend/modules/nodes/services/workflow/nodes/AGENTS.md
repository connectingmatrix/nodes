...
- Workflow nodes bridge runtime execution to service-layer actions.
- Grouped Giga action nodes must route through `executeAction -> executeGigaAction -> services/giga/tree`.
- Do not implement tree CRUD/linking in workflow node handlers.
